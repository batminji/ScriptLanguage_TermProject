...
class MainGUI:
    def __init__(self):
        ...
        search_frame = self.inputSerchText()

        self.inputSearchButton(search_frame)

        list_frame = self.inputListBox()

        self.inputScrollBar(list_frame)

        self.root.mainloop()

    def inputScrollBar(self, list_frame):
        # 스크롤 바 생성
